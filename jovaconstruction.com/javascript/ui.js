...
function positionContent(){
	...
	// Contact
	$('#contact > #block1 > .centered .framed-block .content > .right-block').each(function(){
		$('ul', this).height($('#contact > #block1 > .centered .framed-block .content > .left-block ul').height());
		$('.sectors', this).height($('#contact > #block1 > .centered .framed-block .content > .left-block .sectors').height());
	});
